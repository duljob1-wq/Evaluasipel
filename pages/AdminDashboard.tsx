              ...
              <div className="flex items-center justify-between h-16">
                  ...
                  <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col hidden md:flex">
                          <span className="font-bold text-lg text-white leading-none">SIMEP <span className="text-indigo-400">Admin</span></span>
                          {/* UPT Logo Underneath */}
                          <div className="flex items-center gap-1.5 mt-1 opacity-80">
                            ...
                            />
                             <span className="text-[8px] font-bold text-emerald-400 uppercase tracking-wider leading-none">UPT Latkesmas Murnajati</span>
                          </div>
                      </div>
                  </div>
